...
const sql_insert = `INSERT INTO job_opening (job_id, company_id, position, compensation, job_description, tech) VALUES
  ...
  (4, 1, '프론트엔드 시니어 개발자',  500000, '원티드랩에서 백엔드 시니어 개발자를 채용합니다. 조건은..', 'Python, JavaScript'),
  (5, 2, '프론트엔드 시니어 개발자',  700, '원티드랩에서 프론트엔드 시니어 개발자를 채용합니다. 조건은..', 'JavaScript'),
  (6, 2, '백엔드 시니어 개발자',  600, '원티드랩에서 백엔드 시니어 개발자를 채용합니다. 조건은..', 'Java')`;

db.run(sql_insert, (err) => {
    if (err) {
        return console.error(err.message);
    }
    console.log("Successful created 6 Job Descriptions!");
});
...
// JOB OPENING DETAILS
app.get("/details/:company_id", (req, res) => {
